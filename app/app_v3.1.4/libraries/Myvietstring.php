...
class Myvietstring {
	...
	public static function removeInvalidCharacter($str)
	{
		$patterns[] = '/(,)/';
		$patterns[] = '/(\.)/';
		$patterns[] = '/(?)/';
	...
	public static function remove_html_tags( $text )
	{
	...
	public static function removeVietChars($str)
	{
	...
	public static function vietChars2Lower($str)
	{
		$patterns = array();
		//a
		$patterns[] = '/(à|À)/';
	...
	public static function vietSubStr($str, $numLimit)
	{
		$arrVietChar = array(
	...
	public static function getTitle($str, $ext = ".html")
	{
		...
		$str = self::remove_html_tags($str);
        $str = self::removeVietChars($str);
