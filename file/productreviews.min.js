...
!function (n, t) {
    ...
    "undefined" == typeof BPR && (BPR = {
        host: "https://productreviews.sapoapps.vn/",
        trackingInit: !1,
        store: Bizweb.store,
        extraAjaxParams: {store: Bizweb.store},
        starColor: "inherit",
        lang: "vi",
        bodyMax: 1500,
        config: {},
        ...
        fancybox: function (n, t, i, r) {
            ...
            i.extend(u, {
                ...
                open: function (n, t) {
                    if (n)return (i.isPlainObject(t) || (t = {}), !1 === u.close(!0)) ? void 0 : (i.isArray(n) || (n = a(n) ? i(n).get() : [n]), i.each(n, function (f, e) {
                        ...
                        i.extend(h, {href: s, type: o, content: l, title: p, selector: w});
                        n[f] = h
                ...
                update: function (n) {
                    var t = n && n.type, i = !t || t === "orientationchange";
                ...
                _setDimension: function () {
                    var nt = u.getViewport(), wt = 0, vt = !1, st = !1, v = u.wrap, k = u.skin, e = u.inner,
                        r = u.current, n = r.width, t = r.height, o = r.minWidth, s = r.minHeight, c = r.maxWidth,
                        a = r.maxHeight, bt = r.scrolling, ft = r.scrollOutside ? r.scrollbarWidth : 0, et = r.margin,
                        yt = f(et[1] + et[3]), pt = f(et[0] + et[2]), d, ht, tt, it, p, y, ct, lt, w, g, b, rt, ot, ut,
                        at;
                ...
                _getPosition: function (n) {
                    var i = u.current, r = u.getViewport(), f = i.margin, e = u.wrap.width() + f[1] + f[3],
                        o = u.wrap.height() + f[0] + f[2], t = {position: "absolute", top: f[0], left: f[3]};
            ...
            u.transitions = {
                getOrigPosition: function () {
                    var n = u.current, f = n.element, t = n.orig, i = {}, e = 50, o = 50, s = n.hPadding,
                        c = n.wPadding, r = u.getViewport();
                    ...
                    var n = u.current, t = n.pos, r = n.openEffect, f = r === "elastic", e = i.extend({opacity: 1}, t);
                    delete e.position;
                    ...
                    var n = u.current, i = n.closeEffect, r = i === "elastic", t = {opacity: .1};
                    ...
                    var i = u.current, s = i.nextEffect, t = i.pos, o = {opacity: 1}, r = u.direction, e = 200, n;
                    t.opacity = .1;
            ...
            u.helpers.overlay = {
                defaults: {
                    ...
                    locked: !s,
                    fixed: !0
                }, overlay: null, fixed: !1, el: i("html"), create: function (n) {
            ...
            o.ready(function () {
                ...
                i.scrollbarWidth === r && (i.scrollbarWidth = function () {
                    var n = i('<div style="width:50px;height:50px;overflow:auto"><div/><\/div>').appendTo("body"),
                        t = n.children(), r = t.innerWidth() - t.height(99).innerWidth();
                    return n.remove(), r
                });
        ...
        raty: function (n) {
            ...
            var t = {
                init: function (i) {
                    ...
                    for (var t = ["number", "readOnly", "score", "scoreName", "target", "path"], n = 0; n < t.length; n++)typeof this.opt[t[n]] == "function" && (this.opt[t[n]] = this.opt[t[n]].call(this))
                }, _adjustedScore: function (n) {
                    return n ? t._between(n, 0, this.opt.number) : n
                }, _adjustHints: function () {
                    var f, t, n, i, u, r;
                    if (this.opt.hints || (this.opt.hints = []), this.opt.halfShow || this.opt.half)for (f = this.opt.precision ? 10 : 2, t = 0; t < this.opt.number; t++)for (n = this.opt.hints[t], Object.prototype.toString.call(n) !== "[object Array]" && (n = [n]), this.opt.hints[t] = [], i = 0; i < f; i++)u = n[i], r = n[n.length - 1], r === undefined && (r = null), this.opt.hints[t][i] = u === undefined ? r : u
                    ...
                    for (this.opt.path = "", n = 0; n < t.length; n++)this.opt[t[n]] = this.opt[t[n]].replace(".", "-")
                }, _apply: function (n) {
                    t._fill.call(this, n);
                    n && (n > 0 && this.score.val(n), t._roundStars.call(this, n))
                    ...
                    i.stars.on("click.raty", function (r) {
                        ...
                        (f || f === undefined) && (i.opt.half && !i.opt.precision && (u = t._roundHalfScore.call(i, u)), t._apply.call(i, u))
                    })
                    ...
                    n.cancel.on("mouseleave.raty", function (i) {
                        ...
                        n.opt.mouseout && (u = +n.score.val() || undefined, n.opt.mouseout.call(n, u, i))
                    })
                }, _bindOver: function () {
                    var n = this, i = n.opt.half ? "mousemove.raty" : "mouseover.raty";
                    n.stars.on(i, function (i) {
                        var r = t._getScoreByPosition.call(n, i, this);
                        t._fill.call(n, r);
                        n.opt.half && (t._roundStars.call(n, r, i), t._setTitle.call(n, r, i), n.self.data("score", r));
                        t._target.call(n, r, i);
                    ...
                    n.cancel.on("mouseover.raty", function (i) {
                        var u = n.opt.path + n.opt.starOff, r = n.opt.cancelOn;
                        n.opt.starType === "img" ? n.stars.attr("src", u) : (r = n.opt.cancelClass + " " + r, n.stars.attr("class", u));
                        t._setIcon.call(n, this, r);
                        t._target.call(n, null, i);
                        n.opt.mouseover && n.opt.mouseover.call(n, null)
                    })
                }, _buildScoreField: function () {
                    return n("<input />", {name: this.opt.scoreName, type: "hidden"}).appendTo(this)
                }, _createCancel: function () {
                    var i = this.opt.path + this.opt.cancelOff, t = n("<" + this.opt.starType + " />", {
                        title: this.opt.cancelHint,
                        "class": this.opt.cancelClass
                    });
                    this.opt.starType === "img" ? t.attr({src: i, alt: "x"}) : t.attr("data-alt", "x").addClass(i);
                    ...
                    for (var u, r, i = 1; i <= this.opt.number; i++)u = t._nameForIndex.call(this, i), r = {
                        alt: i,
                        src: this.opt.path + this.opt[u]
                    }, this.opt.starType !== "img" && (r = {
                        "data-alt": i,
                        "class": r.src
                    }), r.title = t._getHint.call(this, i), n("<" + this.opt.starType + " />", r).appendTo(this), this.opt.space && this.self.append(i < this.opt.number ? "&#160;" : "");
                    this.stars = this.self.children(this.opt.starType)
                }, _error: function (t) {
                    n(this).text(t);
                    n.error(t)
                }, _fill: function (n) {
                    for (var r, e, o, u, f = 0, i = 1; i <= this.stars.length; i++)e = this.stars[i - 1], o = t._turnOn.call(this, i, n), this.opt.iconRange && this.opt.iconRange.length > f ? (u = this.opt.iconRange[f], r = t._getRangeIcon.call(this, u, o), i <= u.range && t._setIcon.call(this, e, r), i === u.range && f++) : (r = this.opt[o ? "starOn" : "starOff"], t._setIcon.call(this, e, r))
                }, _getFirstDecimal: function (n) {
                    var t = n.toString().split(".")[1], i = 0;
                    return t && (i = parseInt(t.charAt(0), 10), t.slice(1, 5) === "9999" && i++), i
                    ...
                    return this.opt.half && (f = t._getWidth.call(this), e = parseFloat((i.pageX - n(r).offset().left) / f), u = u - 1 + e), u
                }, _getHint: function (n, i) {
                    if (n !== 0 && !n)return this.opt.noRatedMsg;
                    var r = t._getFirstDecimal.call(this, n), o = Math.ceil(n), f = this.opt.hints[(o || 1) - 1], u = f,
                        e = !i || this.move;
                    return this.opt.precision ? (e && (r = r === 0 ? 9 : r - 1), u = f[r]) : (this.opt.halfShow || this.opt.half) && (r = e && r === 0 ? 1 : r > 5 ? 1 : 0, u = f[r]), u === "" ? "" : u || n
                }, _getWidth: function () {
                    var n = this.stars[0].width || parseFloat(this.stars.eq(0).css("font-size"));
                    return n || t._error.call(this, "Could not get the icon width!"), n
                }, _lock: function () {
                    ...
                    var r = parseInt(n, 10), i = t._getFirstDecimal.call(this, n);
                    return i !== 0 && (i = i > 5 ? 1 : .5), r + i
                }, _roundStars: function (n, i) {
                    var u = (n % 1).toFixed(2), r, f, e;
                    i || this.move ? r = u > .5 ? "starOn" : "starHalf" : u > this.opt.round.down && (r = "starOn", this.opt.halfShow && u < this.opt.round.up ? r = "starHalf" : u < this.opt.round.full && (r = "starOff"));
                    r && (f = this.opt[r], e = this.stars[Math.ceil(n) - 1], t._setIcon.call(this, e, f))
                    ...
                    return this.each(function () {
                        var r = n(this);
                        r.data("readonly") !== !0 && (t[i ? "click" : "score"].call(r, null), this.score.removeAttr("value"))
                    })
                }, click: function (i) {
                    return this.each(function () {
                        n(this).data("readonly") !== !0 && (i = t._adjustedScore.call(this, i), t._apply.call(this, i), this.opt.click && this.opt.click.call(this, i, n.Event("click")), t._target.call(this, i))
                    })
                }, destroy: function () {
                    return this.each(function () {
                        var t = n(this), i = t.data("raw");
                        i ? t.off(".raty").empty().css({cursor: i.style.cursor}).removeData("readonly") : t.data("raw", t.clone()[0])
                    })
                }, getScore: function () {
                    var n = [], t;
                    return this.each(function () {
                    ...
                    return this.each(function () {
                        var r = parseInt(i, 10), u = t._getFirstDecimal.call(this, i);
                        r >= this.opt.number && (r = this.opt.number - 1, u = 10);
                        var e = t._getWidth.call(this), o = e / 10, f = n(this.stars[r]), s = f.offset().left + o * u,
                            h = n.Event("mousemove", {pageX: s});
                        this.move = !0;
                        f.trigger(h);
                        this.move = !1
                    })
                    ...
                    return this.each(function () {
                        var r = n(this);
                        r.data("readonly") !== i && (i ? (r.off(".raty").children("img").off(".raty"), t._lock.call(this)) : (t._binds.call(this), t._unlock.call(this)), r.data("readonly", i))
                    })
                }, reload: function () {
                    ...
                    return this.each(function () {
                        n(this).data("readonly") !== !0 && (i = t._adjustedScore.call(this, i), t._apply.call(this, i), t._target.call(this, i))
                    })
                }
            };
            n.fn.raty = function (i) {
                if (t[i])return t[i].apply(this, Array.prototype.slice.call(arguments, 1));
                if (typeof i != "object" && i) n.error("Method " + i + " does not exist!"); else return t.init.apply(this, arguments)
            };
            n.fn.raty.defaults = {
                cancel: !1,
                ...
                half: !1,
                halfShow: !0,
                hints: ["Rất tệ", "Không hài lòng", "Bình thường", "Hài lòng", "Tuyệt vời"],
                iconRange: undefined,
                mouseout: undefined,
                mouseover: undefined,
        ...
        loadTemplate: function (n) {
            ...
            function c(t, i, r) {
                ...
                return (i = i || {}, u = n.extend(!0, {
                    ...
                    beforeInsert: null,
                    afterInsert: null,
                    bindingOptions: {ignoreUndefined: !1, ignoreNull: !1, ignoreEmptyString: !1}
                }, r), n.type(i) === "array") ? (h = !0, p.call(this, t, i, u)) : (y(t) || (o = n(t), typeof t == "string" && t.indexOf("#") === 0 && (u.isFile = !1)), s = u.isFile || typeof u.isFile == "undefined" && (typeof o == "undefined" || o.length === 0), s && !u.overwriteCache && f[t] ? b(t, e, i, u) : s && !u.overwriteCache && f.hasOwnProperty(t) ? w(t, e, i, u) : s ? d(t, e, i, u) : g(o, e, i, u), this)
            }
            ...
            function p(t, i, r) {
                ...
                return r.paged && (o = (r.pageNo - 1) * r.elemPerPage, i = i.slice(o, o + r.elemPerPage), e = i.length), v = n.extend({}, r, {
                    async: !1,
                    complete: function (t) {
                        if (this.html) {
                            var i;
                        ...
                        h++;
                        (h === e || f) && (f && r && typeof r.error == "function" && r.error.call(u, a), r && typeof r.complete == "function" && r.complete())
                    },
                    success: function () {
                        l++;
                ...
                }), r.append || r.prepend || u.html(""), s && i.reverse(), n(i).each(function () {
                    var i = n("<div/>");
                    return c.call(i, t, this, v), f ? !1 : void 0
                }), this
            }

            function w(n, t, i, u) {
                r[n] ? r[n].push({data: i, selection: t, settings: u}) : r[n] = [{data: i, selection: t, settings: u}]
            }
            ...
            function d(t, i, r, u) {
                ...
                n.ajax({
                    url: e, async: u.async, success: function (n) {
                        o.html(n);
                        tt(o, t, i, r, u)
                    }, error: function (n) {
                        nt(t, i, r, u, n)
            ...
            function nt(t, i, u, f, e) {
                var o;
                for (typeof f.error == "function" && f.error.call(i, e), n(r[t]).each(function (n, t) {
                    typeof t.settings.error == "function" && t.settings.error.call(t.selection, e)
                }), typeof f.complete == "function" && f.complete.call(i); r[t] && (o = r[t].shift());)typeof o.settings.complete == "function" && o.settings.complete.call(o.selection);
                typeof r[t] != "undefined" && r[t].length > 0 && (r[t] = [])
            }

            function tt(n, t, i, u, e) {
                var s;
                for (f[t] = n.clone(), o.call(i, n, u, e), typeof e.success == "function" && e.success.call(i); r[t] && (s = r[t].shift());)o.call(s.selection, f[t].clone(), s.data, s.settings), typeof s.settings.success == "function" && s.settings.success.call(s.selection)
            }
            ...
            function t(t, i, r, u, f, e) {
                n("[" + t + "]", i).each(function () {
                    var i = n(this), h = i.attr(t), o = s(r, h);
                    if (t == "data-src-voters" && r.rating == 0) n("#bpr-summary-caption img").attr("style", "display: none !important"); else if (t != "data-content" || t == "data-content" && o > 0 || t == "data-content-str") {
                        if (!v(i, o, u)) {
                            i.remove();
                            return
                        }
            ...
            function rt(t, i) {
                var r = {};
                return t instanceof jQuery && t.attr("data-binding-options") ? (r = n.parseJSON(t.attr("data-binding-options")), t.removeAttr("data-binding-options")) : typeof t == "object" && t.hasOwnProperty("bindingOptions") && (r = t.bindingOptions), n.extend({}, i.bindingOptions, r)
            }

            function ut(t, i, r) {
                n("[data-template-bind]", t).each(function () {
                    var t = n(this), u = n.parseJSON(t.attr("data-template-bind"));
                    t.removeAttr("data-template-bind");
                    n(u).each(function () {
                        var u, f;
                        if (u = typeof this.value == "object" ? s(i, this.value.data) : s(i, this.value), this.attribute) {
                            if (!v(this, u, r)) {
                                t.remove();
                                return
                            }
            ...
            function s(n, t) {
                if (t === "this")return n;
                for (var u = t.split("."), r, i = n; (r = u.shift()) && typeof i != "undefined" && i != null;)i = i[r];
                return i
            }

            function i(t, i, r, f) {
                var o = t.attr("data-format-target"), e, s;
                return (o === r || !o && r === "content") && (e = t.attr("data-format"), e && typeof u[e] == "function") ? (s = t.attr("data-format-options"), function (r) {
            ...
            l("nestedTemplateFormatter", function (t, i, r) {
                if (i) {
                    ...
                    var u = i.parentElement || "div", f = i.template || i;
        ...
        pagination: function (n) {
            var t = {
                init: function (i) {
                    ...
                    if (t.destroy.call(this), s = typeof this.prop == "function" ? this.prop("tagName") : this.attr("tagName"), f = s === "UL" ? this : n("<ul" + (i.listStyle ? ' class="' + i.listStyle + '"' : "") + "><\/ul>").appendTo(this), i.prevText && t._appendItem.call(this, i.invertPageOrder ? i.currentPage + 1 : i.currentPage - 1, {
                            text: i.prevText,
                            classes: "prev"
                        ...
                        if (r.end < i.pages && i.edges > 0) {
                            if (i.useStartEdge)for (o = Math.max(i.pages - i.edges, r.end), u = i.pages - 1; u >= o; u--)t._appendItem.call(this, u);
                        ...
                        if (i.useStartEdge)for (e = Math.min(i.edges, r.start), u = 0; u < e; u++)t._appendItem.call(this, u);
                    ...
                    if (i.invertPageOrder)for (u = r.end - 1; u >= r.start; u--)t._appendItem.call(this, u); else for (u = r.start; u < r.end; u++)t._appendItem.call(this, u);
                    if (i.invertPageOrder) {
                        if (r.start > 0 && i.edges > 0 && (i.edges < r.start && r.start - i.edges != 1 ? f.append('<li class="disabled"><span class="ellipse">' + i.ellipseText + "<\/span><\/li>") : r.start - i.edges == 1 && t._appendItem.call(this, i.edges), i.useEndEdge))for (e = Math.min(i.edges, r.start), u = e - 1; u >= 0; u--)t._appendItem.call(this, u)
                    } else if (r.end < i.pages && i.edges > 0 && (i.pages - i.edges > r.end && i.pages - i.edges - r.end != 1 ? f.append('<li class="disabled"><span class="ellipse">' + i.ellipseText + "<\/span><\/li>") : i.pages - i.edges - r.end == 1 && t._appendItem.call(this, r.end), i.useEndEdge))for (o = Math.max(i.pages - i.edges, r.end), u = o; u < i.pages; u++)t._appendItem.call(this, u);
                    i.nextText && !i.nextAtFront && t._appendItem.call(this, i.invertPageOrder ? i.currentPage - 1 : i.currentPage + 1, {
                        text: i.nextText,
                        classes: "next"
                    });
                    ...
                    u = n.extend(u, r || {});
                    i == f.currentPage || f.disabled ? (f.disabled || u.classes === "prev" || u.classes === "next" ? o.addClass("disabled") : o.addClass("active"), e = n('<span class="current">' + u.text + "<\/span>")) : (e = n('<a href="' + f.hrefTextPrefix + (i + 1) + f.hrefTextSuffix + '" class="page-link">' + u.text + "<\/a>"), e.click(function (n) {
                    ...
                    var f = this, r = this.data("pagination"), u = i.find(".ellipse");
                    u.addClass("clickable").parent().removeClass("disabled");
                    u.click(function () {
                        if (!r.disable) {
                            var i = n(this), e = (parseInt(i.parent().prev().text(), 10) || 0) + 1;
                            i.html('<input type="number" min="1" max="' + r.pages + '" step="1" value="' + e + '">').find("input").focus().click(function (n) {
                                ...
                                var i = n(this).val();
                                return i !== "" && t._selectPage.call(f, i - 1), u.empty().html(r.ellipseText), !1
                            })
                        }
                        return !1
                    })
            ...
            n.fn.pagination = function (i) {
                ...
                if (typeof i != "object" && i) n.error("Method " + i + " does not exist on jQuery.pagination"); else return t.init.apply(this, arguments)
            }
        },
        swiper: function () {
            (function () {
                ...
                var n, t = function (r, u) {
                    ...
                    if ((f = this, f.params = u, f.originalParams = p, f.classNames = [], typeof n != "undefined" && typeof i != "undefined" && (n = i), typeof n != "undefined" || (n = typeof i == "undefined" ? window.Dom7 || window.Zepto || window.jQuery : i, n)) && (f.$ = n, f.currentBreakpoint = undefined, f.getActiveBreakpoint = function () {
                        ...
                        var c, l, g, nt, w, e, s, tt, ht = "input, select, textarea, button", ct = Date.now(), b,
                            a = [], it;
                                ...
                                fade: {
                                    ...
                                    setTranslate: function () {
                                        for (var w, r, u, b, a = f.translate, v = f.isHorizontal() ? -a + f.width / 2 : -a + f.height / 2, y = f.isHorizontal() ? f.params.coverflow.rotate : -f.params.coverflow.rotate, k = f.params.coverflow.depth, e = 0, d = f.slides.length; e < d; e++) {
                                            var i = f.slides.eq(e), p = f.slidesSizesGrid[e],
        ...
        loadjscssfile: function (n, t) {
            var i;
            t == "js" ? (i = document.createElement("script"), i.setAttribute("type", "text/javascript"), i.setAttribute("src", n)) : t == "css" && (i = document.createElement("link"), i.setAttribute("rel", "stylesheet"), i.setAttribute("type", "text/css"), i.setAttribute("href", n), i.setAttribute("media", "all"));
            typeof i != "undefined" && document.getElementsByTagName("head")[0].appendChild(i)
        },
        showFancyPopup: function (t) {
            n.popupfancybox.open({
                content: t, beforeShow: function () {
                }, afterShow: function () {
                }, scrolling: "no", openEffect: "none", openSpeed: 0, afterClose: function () {
                }
            })
        },
        loadConfig: function () {
            var t = {store: this.store};
            return n.ajax({
        ...
        genReviews: function (t) {
            var l = BPR.language, o = t.reviews, h = "", c, f, r, u, i, s, e;
            if (o != null)for (c = o.length, f = 0; f < c; f++)r = o[f], u = "", r.reply != null && (u += '<div class="bizweb-review-reply">', u += '<p class="bizweb-review-reply-body">' + r.reply.content + "<\/p>", u += '<span class="bizweb-review-reply-shop">- ' + r.reply.author_name + "<\/span>", u += "<\/div>"), i = "", i += '<div id="bizweb-review-' + r.id + '" class="bizweb-review" itemscope="" itemtype="http://schema.org/Review" itemprop="review">', i += '<div class="bizweb-review-header">', i += "<div>", i += '<div class="bizweb-review-header-img">', i += '<img src="' + BPR.host + '/assets/images/user.png" width="16" height="15"/>', i += "<\/div>", i += "<\/div>", i += "<div>", i += '<span class="bizweb-review-header-byline" itemprop="author">' + r.author_name + "<\/span>", i += '<div class="bizweb-product-reviews-star" data-score="' + r.rating + '" data-number="5"><\/div>', i += '<span class="bizweb-review-header-time" itemprop="datePublished">' + r.time + "<\/span>", i += "<\/div>", i += '<div class="bizweb-review-reportreview">', BPR.checkReviewReport(r.id) ? i += '<a href="javascript: void(0);" style="color: red;"><i aria-hidden="true" class="fa fa-warning"><\/i><\/a>' : (i += '<a onclick="BPR.reportReview(' + r.id + ');return false" title="' + l.report + '" href="javascript: void(0);">', i += '<i aria-hidden="true" class="fa fa-warning"><\/i>', i += "<\/a>"), i += "<\/div>", i += '<p class="bizweb-review-header-title">' + r.title + "<\/p>", i += "<\/div>", i += '<div class="bizweb-review-content">', i += '<p class="bizweb-review-content-body" itemprop="description">' + r.content + "<\/p>", i += "<\/div>", i += u, i += '<div class="bizweb-review-footer">', i += "", i += "<\/div>", i += '<div style="display:none;" itemtype="http://schema.org/Rating" itemscope="" itemprop="reviewRating"><span itemprop="ratingValue">' + r.rating + "<\/span><\/div>", i += "<\/div>", h += i;
            return s = n("#bizweb-product-reviews[data-id='" + BPR.product.product_id + "']"), s.find("#bpr-list").html(h), e = s.find("#bpr-more-reviews"), t.records_total > t.limit ? e.pagination({
                ...
                onPageClick: function (n) {
                    e.pagination("disable");
                    BPR.getMoreReviews(n)
                }
            }) : e.html(""), BPR.loadStar(t.rating), void 0
        },
        getMoreReviews: function (t) {
            var r = n(BPR.reviewEl).attr("data-id"), i = {productId: r, page: t};
            return i = n.extend(i, BPR.extraAjaxParams), n.ajax({
        ...
        loadStar: function () {
            var t = ["Rất tệ", "Không hài lòng", "Bình thường", "Hài lòng", "Tuyệt vời"];
            BPR.lang === "en" && (t = ["bad", "poor", "regular", "good", "gorgeous"]);
            n("#bizweb-product-reviews .bizweb-product-reviews-star").raty({
                starType: "i", number: function () {
                    return n(this).attr("data-number")
                }, score: function () {
                    return n(this).attr("data-score")
                }, hints: t, readOnly: !0
            });
            n("#bizweb-product-reviews .bizweb-product-reviews-star").css("color", this.starColor);
            n(window).resize()
        },
        checkCommentator: function () {
            var i = n(BPR.reviewEl).attr("data-id"), t;
            if (t = n("#bizweb-product-reviews[data-id='" + i + "']"), BPR.config.commentator_type == "customer" && ProductReviewsAppUtil.customer == null) {
                n(t).find(".product-reviews-summary-actions").html("");
                n(t).find(".bizweb-product-reviews-form").html("");
                return
            }
            ProductReviewsAppUtil.customer && (n(t).find("form #review_author").val(ProductReviewsAppUtil.customer.name), n(t).find("form #review_email").val(ProductReviewsAppUtil.customer.email));
            return
        },
        checkReviewReport: function (t) {
            if (ProductReviewsAppUtil.customer) {
                var r = BPR.readCookie(), u = ProductReviewsAppUtil.customer.id, i = r[u];
                if (i && i.length > 0 && n.inArray(t, i) != -1)return !0
            }
            return !1
        },
        loadProduct: function () {
            if (this.reviewEl != null && this.reviewEl.length != 0) {
                var t = n(this.reviewEl).attr("data-id"), i = {productId: t, store: this.store};
                return n.get(this.host + "reviews/product", i, this.productCallback, "jsonp"), void 0
            }
        },
        productCallback: function (t) {
            var i = BPR.language;
            return Bizweb.store == "support.bizwebvietnam.net" && (i.title = "Bạn thấy bài viết này hữu ích chứ?", i.newreview = "Đánh giá"), BPR.product = {
            ...
            }), t = n.extend(t, {language: i}), t.name_help == "" && (t.name_help = i.form.review_author), t.email_help == "" && (t.email_help = i.form.review_email), n("#bizweb-product-reviews").loadTemplate(BPR.host + "assets/template/bpr.html", t, {
                complete: function () {
                    BPR.genReviews(t);
                    BPR.checkCommentator();
                    t.votes == 0 && n("#bizweb-product-reviews-summary").remove("")
                }
            }), void 0
        },
        loadBadges: function () {
            ...
            if (t.length > 0)return i = n.extend({productIds: t.splice(0)}, BPR.extraAjaxParams), n.ajax({
        ...
        badgesCallback: function (t) {
            BPR.badgeEls.each(function () {
                var u = n(this).attr("data-id"), r = BPR.filterBadge(t.badges, u), i = "";
                r != null ? (i += '<div class="bizweb-product-reviews-star" data-score="' + r.rating + '" data-number="5" ><\/div>', r.votes > 0 && (i += "<div><p>" + r.votes + "<\/p><\/div>"), i += '<div><img src="' + BPR.host + '/assets/images/user.png" width="18" height="17"/><\/div>') : (i += '<div class="bizweb-product-reviews-star" data-score="0" data-number="5" ><\/div>', r.votes > 0 && (i += "<div><p>" + r.votes + "<\/p><\/div>"), i += '<div><img src="' + BPR.host + '/assets/images/user.png" width="22" height="20"/><\/div>');
                n(this).html(i)
            });
            BPR.loadBadgeStar(BPR.lang)
        },
        filterBadge: function (n, t) {
            for (var r = n.length, i = 0; i < r; i++)if (n[i].id == t)return n[i];
            return null
        },
        loadBadgeStar: function (t) {
            var i = ["Rất tệ", "Không hài lòng", "Bình thường", "Hài lòng", "Tuyệt vời"];
            t === "en" && (i = ["bad", "poor", "regular", "good", "gorgeous"]);
            n(".bizweb-product-reviews-star").raty({
                starType: "i", number: function () {
                    return n(this).attr("data-number")
                }, score: function () {
                    return n(this).attr("data-score")
            ...
            n(".bizweb-product-reviews-star").css("color", this.starColor);
            n(window).resize()
        },
        loadDefaultStar: function () {
            var t = ["Rất tệ", "Không hài lòng", "Bình thường", "Hài lòng", "Tuyệt vời"];
            BPR.lang === "en" && (t = ["bad", "poor", "regular", "good", "gorgeous"]);
            n("#bizweb-product-reviews-frm #dvRating").raty({
                starType: "i", number: 5, hints: t, click: function (t) {
                    n("#bizweb-product-reviews-frm #review_rate").val(t)
                }
            });
            n("#bizweb-product-reviews-frm #dvRating").css("color", this.starColor);
            n(window).resize()
        },
        submitForm: function (t) {
            var i;
            return (i = n(t).serializeObject(), i = n.extend(i, BPR.extraAjaxParams), i.productId = n("#review_product_id").val(), i.score = n("#review_product_id").val(), i.rating = n("#review_rate").val(), i.author = n("#review_author").val(), i.email = n("#review_email").val(), i.title = n("#review_title").val(), i.body = n("#review_body").val(), !BPR.validateForm(i)) ? (n.fancybox.update(), !1) : (n.fancybox.showLoading(), n.ajax({
                ...
                beforeSend: function () {
                    n(".bpr-button-submit").attr("disabled", "disabled");
                    return
                },
                complete: function () {
                    n(".bpr-button-submit").removeAttr("disabled");
                    n.fancybox.hideLoading();
                    return
                }
            }), !1)
        },
        formCallback: function (t) {
            ...
            n.fancybox({
                href: "#bpr-thanks", afterShow: function () {
                }, afterClose: function () {
                }
            });
            n("#btnnewreview").remove()
        },
        toggleForm: function (t) {
            var i;
            return i = n(t).parents("#bizweb-product-reviews[data-id]").attr("data-id"), n.fancybox({
                href: "#bpr-form_" + i,
                afterShow: function () {
                    BPR.loadDefaultStar()
                },
        ...
        validateForm: function (t) {
            var i = BPR.language.form, r = !1, u = !1, f = !1, e = !1, o = !1;
            return t.rating == "" || t.rating < 1 || t.rating > 5 ? n("#bizweb-product-reviews-frm .bpr-form-rating .bpr-form-message-error").html(i.rating_error.error).show() : (n("#bizweb-product-reviews-frm .bpr-form-rating .bpr-form-message-error").hide(), r = !0), t.author == "" && BPR.config.name_required == "require" ? (n("#bizweb-product-reviews-frm .bpr-form-contact-name").addClass("has-error"), n("#bizweb-product-reviews-frm .bpr-form-contact-name .bpr-form-message-error").html(i.name_error.required)) : t.author.length > 128 ? (n("#bizweb-product-reviews-frm .bpr-form-contact-name").addClass("has-error"), n("#bizweb-product-reviews-frm .bpr-form-contact-name .bpr-form-message-error").html(i.name_error.maxlength)) : (n("#bizweb-product-reviews-frm .bpr-form-contact-name").removeClass("has-error"), u = !0), t.email == "" && BPR.config.email_required == "require" ? (n("#bizweb-product-reviews-frm .bpr-form-contact-email").addClass("has-error"), n("#bizweb-product-reviews-frm .bpr-form-contact-email .bpr-form-message-error").html(i.email_error.required)) : t.email.length > 128 ? (n("#bizweb-product-reviews-frm .bpr-form-contact-email").addClass("has-error"), n("#bizweb-product-reviews-frm .bpr-form-contact-email .bpr-form-message-error").html(i.email_error.maxlength)) : t.email == "" || BPR.isValidEmailAddress(t.email) ? (n("#bizweb-product-reviews-frm .bpr-form-contact-email").removeClass("has-error"), f = !0) : (n("#bizweb-product-reviews-frm .bpr-form-contact-email").addClass("has-error"), n("#bizweb-product-reviews-frm .bpr-form-contact-email .bpr-form-message-error").html(i.email_error.error)), t.title == "" ? (n("#bizweb-product-reviews-frm .bpr-form-review-title").addClass("has-error"), n("#bizweb-product-reviews-frm .bpr-form-review-title .bpr-form-message-error").html(i.title_error.required)) : t.title.length > 512 ? (n("#bizweb-product-reviews-frm .bpr-form-review-title").addClass("has-error"), n("#bizweb-product-reviews-frm .bpr-form-review-title .bpr-form-message-error").html(i.title_error.maxlength)) : (n("#bizweb-product-reviews-frm .bpr-form-review-title").removeClass("has-error"), e = !0), t.body == "" ? (n("#bizweb-product-reviews-frm .bpr-form-review-body").addClass("has-error"), n("#bizweb-product-reviews-frm .bpr-form-review-body .bpr-form-message-error").html(i.body_error.required)) : t.body.length > 1500 ? (n("#bizweb-product-reviews-frm .bpr-form-review-body").addClass("has-error"), n("#bizweb-product-reviews-frm .bpr-form-review-body .bpr-form-message-error").html(i.body_error.maxlength)) : (n("#bizweb-product-reviews-frm .bpr-form-review-body").removeClass("has-error"), o = !0), r == !1 || u == !1 || f == !1 || e == !1 || o == !1 ? !1 : !0
        },
        ...
        reportReview: function (t) {
            ...
            return confirm(r.report_alert) && (i = n.extend({id: t}, BPR.extraAjaxParams), n.get("" + BPR.host + "/reviews/report", i, BPR.reportCallback, "jsonp")), !1
        },
        reportCallback: function (t) {
            var i, r;
            n("#bizweb-review-" + t.id).find(".bizweb-review-reportreview").html('<a href="javascript: void(0);" style="color: red;"><i aria-hidden="true" class="fa fa-warning"><\/i><\/a>');
            ProductReviewsAppUtil.customer && (i = BPR.readCookie(), r = ProductReviewsAppUtil.customer.id, i[r] && i[r].length != 0 || (i[r] = []), i[r].push(t.id), BPR.writeCookie(i));
            return
        },
        initDomEls: function () {
            this.badgeEls = n(".bizweb-product-reviews-badge[data-id]");
            this.reviewEl = n("#bizweb-product-reviews[data-id]").first();
            this.moduleEl = n(".bizweb-product-reviews-module")
        },
        loadProductsModule: function () {
            if (BPR.moduleEl.length && BPR.moduleEl.length > 0) {
                var t = {store: Bizweb.store, page: Bizweb.template};
                n.ajax({
        ...
        productsModuleCallback: function (t) {
            var r, u, i;
            t == null || t.length <= 0 || (BPR.moduleEl.html(t), r = parseInt(BPR.moduleEl.find(".bpr-products-module-slide").val(), 10), u = {}, n(".bpr-products-module-body.swiper-container").length && n(".bpr-products-module-body.swiper-container").length > 0 && n(".bpr-products-module-body.swiper-container").each(function (t) {
                var e = n(this), o = e.parents(".bpr-products-module-container"), s = e.find(".bpr-wrapper-outer"), i,
                    f;
                ...
                f = s.width();
                f <= 320 ? (i.slidesPerView = 1, i.spaceBetween = 0, i.breakpoints = {}) : f <= 768 ? (i.slidesPerView = 2, i.spaceBetween = 10, i.breakpoints = {
                    320: {
                        slidesPerView: 1,
                        spaceBetween: 0
                    }
                }) : f <= 992 ? (i.slidesPerView = 3, i.spaceBetween = 20, i.breakpoints = {
                    320: {
                        slidesPerView: 1,
                        spaceBetween: 0
                    }, 768: {slidesPerView: 2, spaceBetween: 10}, 992: {slidesPerView: 3, spaceBetween: 20}
                }) : (i.slidesPerView = r, i.spaceBetween = 30, i.breakpoints = {
                    320: {
                        slidesPerView: 1,
                        spaceBetween: 0
                    }, 768: {slidesPerView: 2, spaceBetween: 10}, 992: {slidesPerView: 3, spaceBetween: 20}
                });
                u[t] = new Swiper(".bpr-products-module-body.swiper-container.instance-" + t + " .bpr-wrapper-outer", i)
            }), i = ["Rất tệ", "Không hài lòng", "Bình thường", "Hài lòng", "Tuyệt vời"], BPR.lang === "en" && (i = ["bad", "poor", "regular", "good", "gorgeous"]), n(".bizweb-product-reviews-module .bpr-product-star").raty({
                starType: "i",
                number: function () {
                    return n(this).attr("data-number")
                },
        ...
        writeCookie: function (n) {
            var t = new Date;
            t = t.getTime();
            var i = Math.round(t + BPR.cookie_expire * 36e5), r = new Date(i), u = r.toGMTString(),
                n = JSON.stringify(n);
        ...
        readCookie: function () {
            ...
            for (var t = null, r = "bpr-app=", u = document.cookie.split(";"), i = 0; i < u.length; i++) {
                for (n = u[i]; " " == n.charAt(0);)n = n.substring(1, n.length);
                if (0 == n.indexOf(r)) {
                    t = n.substring(r.length, n.length);
                    break
                }
            }
            return t && (BPR.cookies = JSON.parse(t)), BPR.cookies
        }
    });
    BPR.trackingInit || (BPR.trackingInit = !0, BPR.fancybox(window, document, n, undefined), BPR.raty(n), BPR.serializeObject(n), BPR.loadTemplate(n), BPR.pagination(n), BPR.swiper(), n(document).ready(function () {
        BPR.init()
    }))
}.call(this);