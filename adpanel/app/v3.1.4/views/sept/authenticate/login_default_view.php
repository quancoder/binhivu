...
<head>
    ...
    <!--load CSS-->
    <link type="text/css" rel="stylesheet" href="<?php echo base_url() . "skins/" . ltrim(URI_PATH . '/', '/') . $template_f; ?>domain/default/default.css?v=2">
    ...
    <script type="text/javascript" src="<?php echo base_url() . 'js/' . ltrim(URI_PATH . '/', '/') . $template_f; ?>jquery_2.1.4.min.js"></script>
</head>
<?php flush();?>
