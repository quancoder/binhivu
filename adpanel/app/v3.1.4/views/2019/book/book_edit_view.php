            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="ml-3 float-right">
                        <a href="<?= site_url('document/add', $langcode) ?>" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i> Thêm sách</a>
                    </li>
                </ol>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex justify-content-center">
                                    <img id="image_preview" src="<?= ROOT_DOMAIN. $info['b_image'] ?>" style="width:50%; background-color: white; display: <?= $info['b_image'] == '' ? 'none' : 'block'?>"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea id="b_des" name="b_des"  class="form-control" placeholder="Mô tả:" required><?= $info['b_des'] ?></textarea>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-center">
                            <button type="submit" name="submit" value="ok" class="btn btn-primary"><i class="fa fa-pencil"></i> Lưu thay đổi</button>
                        </div>
                    </div>
                </div>
            </div>
