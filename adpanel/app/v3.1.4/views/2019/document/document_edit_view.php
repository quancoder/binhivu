            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="ml-3 float-right">
                        <a href="<?= site_url('document/add', $langcode) ?>" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i> Tạo tài liệu</a>
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <div style="margin: 10px 0; ">
                            <img id="image_preview" src="<?= ROOT_DOMAIN. $info['doc_image'] ?>" style="width:50%; background-color: white; display: <?= $info['doc_image'] == '' ? 'none' : 'block'?>"/>
                        </div>
                    </div>
                </div>
            </div>
