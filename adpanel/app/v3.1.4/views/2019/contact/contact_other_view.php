...
<div class="container-fluid">
    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="content-email-tab" data-toggle="pill" href="#content-email" role="tab" aria-controls="content-email" aria-selected="true">Đăng ký nhận bài viết</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="content-lienhe-tab" data-toggle="pill" href="#content-lienhe" role="tab" aria-controls="content-lienhe" aria-selected="false">Profile</a>
        </li>
    </ul>
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 class="card-title"><i class="far fa-envelope"></i> Đăng ký mới</h4>
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h4 class="card-title"><i class="far fa-envelope-open"></i> Đăng ký đã xử lý</h4>
        ...
        <div class="col-md-6">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 class="card-title"><i class="far fa-envelope"></i> Liên hệ mới</h4>
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h4 class="card-title"><i class="far fa-envelope-open"></i> Liên hệ đã xử lý</h4>
